# UI Revamp Briefs - Complete List

This document contains briefs for all pages, modals, forms, tabs, and UI elements in the DailyFitness application. Each brief includes:
- Purpose/Function
- Key Elements
...
### 1. Client Dashboard (Home) - `/client/page.tsx`
...
### 2. Client Workouts List - `/client/workouts/page.tsx`
...
### 3. Workout Details - `/client/workouts/[id]/details/page.tsx`
...
### 4. Workout Execution (Live Workout) - `/client/workouts/[id]/start/page.tsx`
...
### 5. Workout Completion - `/client/workouts/[id]/complete/page.tsx`
...
### 6. Client Nutrition - `/client/nutrition/page.tsx`
...
### 7. Create Custom Food - `/client/nutrition/foods/create/page.tsx`
...
### 8. Food Details - `/client/nutrition/foods/[id]/page.tsx`
...
### 9. Create Meal - `/client/nutrition/meals/[id]/page.tsx` (if exists)
...
### 10. Meal Details - `/client/nutrition/meals/[id]/page.tsx`
...
### 11. Client Progress Hub - `/client/progress/page.tsx`
...
### 12. Body Metrics - `/client/progress/body-metrics/page.tsx`
...
### 13. Mobility Metrics - `/client/progress/mobility/page.tsx`
...
### 14. Personal Records - `/client/progress/personal-records/page.tsx`
...
### 15. Achievements - `/client/progress/achievements/page.tsx`
...
### 16. Goals & Habits - `/client/progress/goals/page.tsx`
...
### 17. Workout Analytics - `/client/progress/analytics/page.tsx`
...
### 18. Performance Tests - `/client/progress/performance/page.tsx`
...
### 19. Workout Logs - `/client/progress/workout-logs/page.tsx`
...
### 20. Workout Log Details - `/client/progress/workout-logs/[id]/page.tsx`
...
### 21. Client Goals - `/client/goals/page.tsx`
...
### 22. Client Habits - `/client/habits/page.tsx`
...
### 23. Client Challenges - `/client/challenges/page.tsx`
...
### 24. Challenge Details - `/client/challenges/[id]/page.tsx`
...
### 25. Client Sessions - `/client/sessions/page.tsx`
...
### 26. Client Scheduling - `/client/scheduling/page.tsx`
...
### 27. Client Clipcards - `/client/clipcards/page.tsx`
...
### 28. Client Profile - `/client/profile/page.tsx`
...
### 29. Client Programs - `/client/programs/[id]/details/page.tsx`
...
### 30. Client Achievements (separate page) - `/client/achievements/page.tsx`
...
### 31. Coach Dashboard - `/coach/page.tsx`
...
### 32. Coach Menu - `/coach/menu/page.tsx`
...
### 33. Coach Clients List - `/coach/clients/page.tsx`
...
### 34. Add Client - `/coach/clients/add/page.tsx`
...
### 35. Client Detail View - `/coach/clients/[id]/page.tsx`
...
### 36. Client Profile (Coach View) - `/coach/clients/[id]/profile/page.tsx`
...
### 37. Client Workouts (Coach View) - `/coach/clients/[id]/workouts/page.tsx`
...
### 38. Client Nutrition (Coach View) - `/coach/clients/[id]/meals/page.tsx`
...
### 39. Client Progress (Coach View) - `/coach/clients/[id]/progress/page.tsx`
...
### 40. Client Goals (Coach View) - `/coach/clients/[id]/goals/page.tsx`
...
### 41. Client Habits (Coach View) - `/coach/clients/[id]/habits/page.tsx`
...
### 42. Client Clipcards (Coach View) - `/coach/clients/[id]/clipcards/page.tsx`
...
### 43. Client Adherence (Coach View) - `/coach/clients/[id]/adherence/page.tsx`
...
### 44. Client Analytics (Coach View) - `/coach/clients/[id]/analytics/page.tsx`
...
### 45. FMS Assessment - `/coach/clients/[id]/fms/page.tsx`
...
### 46. Programs & Workouts Hub - `/coach/programs-workouts/page.tsx`
...
### 47. Workout Templates List - `/coach/workouts/templates/page.tsx`
...
### 48. Create Workout Template - `/coach/workouts/templates/create/page.tsx`
...
### 49. Edit Workout Template - `/coach/workouts/templates/[id]/edit/page.tsx`
...
### 50. Workout Template Details - `/coach/workouts/templates/[id]/page.tsx`
...
### 51. Programs List - `/coach/programs/page.tsx`
...
### 52. Create Program - `/coach/programs/create/page.tsx`
...
### 53. Edit Program - `/coach/programs/[id]/edit/page.tsx`
...
### 54. Program Details - `/coach/programs/[id]/page.tsx`
...
### 55. Exercise Library - `/coach/exercises/page.tsx`
...
### 56. Exercise Categories - `/coach/exercise-categories/page.tsx`
...
### 57. Workout Categories - `/coach/categories/page.tsx`
...
### 58. Coach Nutrition - `/coach/nutrition/page.tsx`
...
### 59. Meal Plans List - `/coach/nutrition/meal-plans/page.tsx`
...
### 60. Create Meal Plan - `/coach/nutrition/meal-plans/create/page.tsx`
...
### 61. Edit Meal Plan - `/coach/nutrition/meal-plans/[id]/edit/page.tsx`
...
### 62. Meal Plan Details - `/coach/nutrition/meal-plans/[id]/page.tsx`
...
### 63. Coach Meals - `/coach/meals/page.tsx`
...
### 64. Coach Analytics - `/coach/analytics/page.tsx`
...
### 65. Coach Progress - `/coach/progress/page.tsx`
...
### 66. Coach Goals - `/coach/goals/page.tsx`
...
### 67. Coach Habits - `/coach/habits/page.tsx`
...
### 68. Coach Sessions - `/coach/sessions/page.tsx`
...
### 69. Coach Scheduling - `/coach/scheduling/page.tsx`
...
### 70. Coach Availability - `/coach/availability/page.tsx`
...
### 71. Coach Clipcards - `/coach/clipcards/page.tsx`
...
### 72. Coach Challenges - `/coach/challenges/page.tsx`
...
### 73. Challenge Details (Coach) - `/coach/challenges/[id]/page.tsx`
...
### 74. Coach Achievements - `/coach/achievements/page.tsx`
...
### 75. Coach Compliance - `/coach/compliance/page.tsx`
...
### 76. Coach Adherence - `/coach/adherence/page.tsx`
...
### 77. Bulk Assignments - `/coach/bulk-assignments/page.tsx`
...
### 78. Coach Reports - `/coach/reports/page.tsx`
...
### 79. Coach Notifications - `/coach/notifications/page.tsx`
...
### 80. Coach Profile - `/coach/profile/page.tsx`
...
### 84. Program Details Modal (Coach)
...
### 90. Exercise Alternatives Modal
...
### 100. Category Form (Workout Categories)
...
## TABS/SECTIONS (Within Pages)

### 108. Client Progress Page Tabs
...
### 110. Coach Meals/Nutrition Tabs
...
### 115. Workout Block Executors (13 Types)
