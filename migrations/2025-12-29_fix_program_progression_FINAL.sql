...
-- FINAL VERSION - Drops existing functions first
-- ============================================================================
...
-- ============================================================================
-- PART 2: DROP and Recreate get_next_due_workout Function
-- ============================================================================
...
-- Create new function
CREATE FUNCTION get_next_due_workout(p_client_id UUID)
RETURNS JSON AS $$
DECLARE
  v_progress RECORD;
  v_schedule RECORD;
...
-- ============================================================================
-- PART 3: DROP and Recreate complete_workout Function
-- ============================================================================

-- Drop existing function if it exists (handles signature changes)
DROP FUNCTION IF EXISTS complete_workout(UUID, UUID, UUID);
DROP FUNCTION IF EXISTS complete_workout(UUID, INT, INT, UUID, INT, TEXT);

-- Create new function
CREATE FUNCTION complete_workout(
