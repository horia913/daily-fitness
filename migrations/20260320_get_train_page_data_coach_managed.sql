-- ============================================================================
-- get_train_page_data: add progressionMode, coachUnlockedWeek, coach review notes
-- ============================================================================
...
BEGIN
  ...
  -- Latest coach review notes for current unlocked week
...
'Returns all data for the client Train page. Includes progressionMode, coachUnlockedWeek, and latest coach review notes for coach-managed progression.';
