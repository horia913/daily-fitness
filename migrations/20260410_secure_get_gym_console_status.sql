-- ============================================================================
-- Secure get_gym_console_status by binding coach scope to auth.uid()
-- ============================================================================
...
'Returns gym console status for multiple clients in one call: active_session, program_name, next_workout, status, current_week, current_day. Replaces per-client getProgramState calls. Coach scope is bound to auth.uid(); p_coach_id is ignored.';
