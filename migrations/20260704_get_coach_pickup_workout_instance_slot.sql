-- =============================================================================
-- Step 12 — get_coach_pickup_workout off program_progress (ledger-derived slot)
-- Prerequisite: get_next_incomplete_program_slot (20260702).
-- Replaces master program_schedule + program_progress pointer with instance slot.
-- =============================================================================
...
COMMENT ON FUNCTION public.get_coach_pickup_workout(uuid) IS
  'Coach gym-console next workout. Ledger-derived slot via get_next_incomplete_program_slot; no program_progress.';
