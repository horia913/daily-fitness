-- ============================================================================
-- Train page: "completed for today" = completions in current program week only
-- - get_train_page_data: add assignmentStartDate (created_at) for week math
-- - Completions already include completed_at (no change to completions subquery)
-- ============================================================================
...
BEGIN
  -- Get active program assignment (single row; created_at = assignment start for week math)
  ...
  -- Build full result: schedule, completions (with completed_at), assignmentStartDate, extra workouts
...
'Returns all data needed for the client Train page. assignmentStartDate (created_at) used for current-week completion filtering. Day card shows completed only if completion completed_at falls in current program week.';
