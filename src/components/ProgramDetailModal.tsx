...
export default function ProgramDetailModal({ isOpen, onClose, program, onEdit }: ProgramDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] overflow-hidden">
      ...
      >
        {/* Header */}
        <div className={`sticky top-0 ${safeTheme.card} fc-card-shell border-b ${safeTheme.border} px-6 py-5 rounded-t-3xl flex-shrink-0`}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          {loading ? (
            ...
            <>
              {/* Program Overview */}
              <Card className={`${safeTheme.card} fc-card-shell border ${safeTheme.border} rounded-2xl`}>
        ...
        {/* Footer */}
        <div className={`${safeTheme.card} fc-card-shell border-t ${safeTheme.border} px-6 py-4 rounded-b-3xl flex justify-end gap-3 flex-shrink-0`}>
          <Button
            variant="outline"
            onClick={onClose}
