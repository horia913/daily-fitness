...
export default function ExerciseForm({ isOpen, onClose, onSuccess, exercise }: ExerciseFormProps) {
  ...
  return (
    ...
    >
      <div 
        className={`relative ${theme.card} ${theme.shadow} fc-card-shell rounded-3xl border ${theme.border} w-full overflow-hidden transform transition-all duration-300 ease-out flex flex-col`}
        style={{
      ...
      >
        {/* Header - Sticky */}
        <div className={`${theme.card} fc-card-shell border-b ${theme.border} px-6 py-5 rounded-t-3xl flex-shrink-0`}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <form onSubmit={handleSubmit} className="space-y-8">
            {/* Basic Information */}
            <Card className={`${theme.card} fc-card-shell border ${theme.border} rounded-2xl`}>
