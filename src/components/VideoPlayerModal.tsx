  ...
  return (
    <ModalPortal isOpen={isOpen}>
      ...
      >
        {/* Header - Sticky */}
        {title && (
          <div className={`${theme.card} fc-card-shell border-b ${theme.border} px-4 sm:px-6 py-4 flex-shrink-0`}>
        ...
        <div className={`${theme.card} fc-card-shell border-t ${theme.border} px-4 sm:px-6 py-3 flex-shrink-0`}>
