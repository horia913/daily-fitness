  ...
  return (
    <input
      ...
      className={cn(
        baseClass,
        variant === "fc"
          ? "focus-visible:border-[var(--fc-accent)] focus-visible:ring-2 focus-visible:ring-[color:color-mix(in_srgb,var(--fc-accent)_20%,transparent)]"
