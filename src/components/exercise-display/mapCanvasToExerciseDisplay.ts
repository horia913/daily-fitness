...
export const CANVAS_PROTOCOL_SEGMENT_MAP = {
  straight_set: 'sets×reps · load · RPE · tempo · rest',
  superset: 'group meta: set type · rounds · rest; each slot: sets×reps · load · RPE · tempo · rest',
  giant_set: 'same as superset with A1/A2/A3 sub-badges',
  drop_set: 'sets×reps · load · RPE · tempo · rest · drop chain from prescription rows / drop%',
  cluster_set: 'sets×reps · load · RPE · tempo · rest · clusters×reps_per_cluster · intra-cluster rest',
  rest_pause: 'sets×reps · load · RPE · tempo · rest · + up to N rest-pause × Ns',
  pre_exhaustion: 'mapped as multi-slot superset (deriveSetType → superset)',
  amrap: 'compact reps values · load · RPE · tempo · AMRAP N min (group duration)',
  emom: 'reps values (no set prefix) · load · RPE · tempo · every Ns · N min',
  tabata: 'work_seconds values · group meta tabata; all slots measurement=time',
  for_time: 'sets×reps · load · RPE · tempo · rest · cap m:ss',
