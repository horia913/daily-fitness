...
export default function MobileDebugPanel() {
  ...
  const runAllTests = async () => {
    ...
    addResult('User Authentication', !!user, { userId: user?.id, email: user?.email })
    ...
    try {
      ...
      addResult('Workout Assignments Query', !assignmentsError, assignments, assignmentsError)
    } catch (error) {
    ...
    try {
      ...
      addResult('Workout Templates Query', !templatesError, templates, templatesError)
    } catch (error) {
    ...
    try {
      ...
      addResult('Clients Relationship Query', !clientsError, clients, clientsError)
    } catch (error) {
    ...
    try {
      ...
      addResult('Today\'s Workout Query', !todaysError, todaysWorkout, todaysError)
    } catch (error) {
    ...
    try {
      ...
      addResult('Any Workout Assignments', !anyWorkoutsError, anyWorkouts, anyWorkoutsError)
    } catch (error) {
    ...
    try {
      ...
      addResult('All Workout Assignments (Any User)', !allWorkoutsError, allWorkouts, allWorkoutsError)
    } catch (error) {
    ...
    try {
      ...
      addResult('All Client Relationships (Any User)', !allClientsError, allClients, allClientsError)
    } catch (error) {
