          ...
          <div className="max-w-7xl mx-auto space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Link href="/coach/programs-workouts">
                    <Button
                      className="w-full text-white flex flex-col items-center justify-center gap-2"
                      style={{
                        background:
                          "linear-gradient(135deg, #2196F3 0%, #64B5F6 100%)",
                        borderRadius: "20px",
            ...
            >
              ...
              >
                ...
                to view detailed progress, workouts, meals, goals, habits, and
                more in dedicated pages.
              </p>
