                ...
                <TabsContent value="send" className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {notificationTypes.map((type) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`p-2 rounded-lg bg-gradient-to-r ${type.color} ${theme.shadow}`}
                              >
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span
                            className={`text-sm ${theme.textSecondary} ml-auto`}
                          >
                            {selectedClients.length} of{" "}
                            {getFilteredClients().length} selected
                          </span>
                        </div>
                          ...
                          {getFilteredClients().map((client) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                  <div
                                    className={`w-10 h-10 rounded-xl ${getClientAvatarColor(
                                      client.name
                                    )} ${
                                      theme.shadow
                                ...
                                {selectedClients.includes(client.id) && (
                                  <div
                                    className={`p-1 rounded-lg bg-gradient-to-r from-green-500 to-green-600 ${theme.shadow}`}
                                  >
                  ...
                  <Card className={`${theme.card} ${theme.shadow} rounded-2xl`}>
                    <CardHeader className="p-6">
                      ...
                      >
                        <div
                          className={`p-2 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 ${theme.shadow}`}
                        >
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-6">
                        {/* Enhanced Preview */}
                        <div
                          className={`p-6 bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900/20 dark:to-slate-800/20 rounded-xl border-2 ${theme.border}`}
                        >
                          ...
                          <div
                            className={`p-4 ${theme.card} rounded-xl ${theme.shadow} border-2 ${theme.border}`}
                          >
                            <div className="flex items-start gap-3">
                              <div
                                className={`w-8 h-8 rounded-lg bg-gradient-to-r from-purple-500 to-purple-600 ${theme.shadow} flex items-center justify-center`}
                              >
                ...
                <TabsContent value="preferences" className="space-y-6">
                  ...
                  <Card className={`${theme.card} ${theme.shadow} rounded-2xl`}>
                    <CardHeader className="p-6">
                      ...
                      <CardDescription className={`${theme.textSecondary}`}>
                        Choose which client activities you want to be notified
                        about
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="p-6 space-y-6">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className={`text-sm ${theme.textSecondary}`}>
                                Get notified when clients complete workouts
                              </p>
                            </div>
                          </div>
                          <Switch
                        ...
                        <div className="flex items-center justify-between p-4 rounded-xl border-2 border-yellow-200 dark:border-yellow-700 bg-yellow-50 dark:bg-yellow-900/20">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className={`text-sm ${theme.textSecondary}`}>
                                Get notified when clients reach their goals
                              </p>
                            </div>
                          </div>
                          <Switch
                        ...
                        <div className="flex items-center justify-between p-4 rounded-xl border-2 border-red-200 dark:border-red-700 bg-red-50 dark:bg-red-900/20">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className={`text-sm ${theme.textSecondary}`}>
                                Get notified when clients miss scheduled
                                sessions
                              </p>
                            </div>
                          </div>
                    ...
                    <CardContent className="p-6">
                      <div className="space-y-4">
                        <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl border border-green-200 dark:border-green-700">
                          ...
                          <div className="flex-1">
                            <p className={`font-medium ${theme.text}`}>
                              Workout Reminder - Morning Session
                            </p>
                            <p className={`text-sm ${theme.textSecondary}`}>
                              Sent to 4 clients • 2 hours ago
                            </p>
                          </div>
                        ...
                        <div className="flex items-center gap-4 p-4 bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 rounded-xl border border-amber-200 dark:border-amber-700">
                          <div
                            className={`p-2 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 ${theme.shadow}`}
                          >
                            <AlertCircle className="w-5 h-5 text-white" />
                          </div>
                          <div className="flex-1">
                            <p className={`font-medium ${theme.text}`}>
                              Session Reschedule Notice
                            </p>
                            <p className={`text-sm ${theme.textSecondary}`}>
                              Sent to Maria Johnson • 2 days ago
                            </p>
                          </div>
