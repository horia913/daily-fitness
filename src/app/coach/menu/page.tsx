    ...
    <ProtectedRoute requiredRole="coach">
      <div style={{ 
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className={`absolute top-20 -left-20 w-72 h-72 ${isDark ? 'bg-purple-500/10' : 'bg-purple-200/40'} rounded-full blur-3xl`}></div>
          <div className={`absolute top-40 -right-20 w-96 h-96 ${isDark ? 'bg-orange-500/10' : 'bg-orange-200/40'} rounded-full blur-3xl`}></div>
          <div className={`absolute -bottom-20 left-1/3 w-80 h-80 ${isDark ? 'bg-green-500/10' : 'bg-green-200/40'} rounded-full blur-3xl`}></div>
        </div>

        {/* Content */}
        <div className="relative z-10" style={{ padding: '24px 20px', paddingBottom: '100px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '16px' }}>
                ...
                <div>
                  ...
                  <p style={{ 
                    ...
                    margin: 0
                  }}>Access all your coaching tools and features</p>
                </div>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px' }}>
                <Link href="/coach/clients">
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.backgroundColor = isDark ? '#2A2A2A' : '#F9FAFB'
