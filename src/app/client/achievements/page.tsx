...
export default function ClientAchievements() {
  ...
  const [sortBy, setSortBy] = useState<'newest' | 'oldest' | 'progress' | 'rarity'>('newest')
    ...
    try {
      ...
      const allAchievements: Achievement[] = [
        // Streak Achievements
        {
          ...
          is_earned: earnedData?.some(a => a.title === 'First Steps') || false,
          earned_at: earnedData?.find(a => a.title === 'First Steps')?.earned_at,
          progress: 1,
          max_progress: 1
        },
        {
          ...
          value: '3',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Getting Started') || false,
          earned_at: earnedData?.find(a => a.title === 'Getting Started')?.earned_at,
          progress: 3,
          max_progress: 3
        },
        {
          ...
          value: '5',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Consistency King') || false,
          earned_at: earnedData?.find(a => a.title === 'Consistency King')?.earned_at,
          progress: 5,
          max_progress: 5
        },
        {
          ...
          value: '10',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Dedication Master') || false,
          earned_at: earnedData?.find(a => a.title === 'Dedication Master')?.earned_at,
          progress: 5,
          max_progress: 10
        },
        {
          ...
          earned_at: earnedData?.find(a => a.title === 'Iron Will')?.earned_at,
          progress: 5,
          max_progress: 30
        },
        ...
        // Personal Record Achievements
        {
          ...
          value: '1',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Personal Best') || false,
          earned_at: earnedData?.find(a => a.title === 'Personal Best')?.earned_at,
          progress: 1,
          max_progress: 1
        },
        {
          ...
          value: '5',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Record Breaker') || false,
          earned_at: earnedData?.find(a => a.title === 'Record Breaker')?.earned_at,
          progress: 2,
          max_progress: 5
        },
        {
          ...
          earned_at: earnedData?.find(a => a.title === 'PR Machine')?.earned_at,
          progress: 2,
          max_progress: 10
        },
        ...
        // Goal Achievements
        {
          ...
          value: '5',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Weekly Warrior') || false,
          earned_at: earnedData?.find(a => a.title === 'Weekly Warrior')?.earned_at,
          progress: 3,
          max_progress: 5
        },
        {
          ...
          value: '20',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Monthly Master') || false,
          earned_at: earnedData?.find(a => a.title === 'Monthly Master')?.earned_at,
          progress: 8,
          max_progress: 20
        },
        ...
        // Milestone Achievements
        {
          ...
          value: '50',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Half Century') || false,
          earned_at: earnedData?.find(a => a.title === 'Half Century')?.earned_at,
          progress: 12,
          max_progress: 50
        },
        {
          ...
          value: '100',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Century Club') || false,
          earned_at: earnedData?.find(a => a.title === 'Century Club')?.earned_at,
          progress: 12,
          max_progress: 100
        },
        {
          ...
          value: '500',
          created_at: new Date().toISOString(),
          is_earned: earnedData?.some(a => a.title === 'Fitness Legend') || false,
          earned_at: earnedData?.find(a => a.title === 'Fitness Legend')?.earned_at,
          progress: 12,
          max_progress: 500
        }
      ]
  ...
  const getAchievementColor = (type: string) => {
    switch (type) {
      case 'streak': return 'text-orange-600 bg-orange-50 border-orange-200 dark:text-orange-400 dark:bg-orange-900/20 dark:border-orange-800'
      case 'pr': return 'text-green-600 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-900/20 dark:border-green-800'
      case 'goal': return 'text-blue-600 bg-blue-50 border-blue-200 dark:text-blue-400 dark:bg-blue-900/20 dark:border-blue-800'
      case 'milestone': return 'text-purple-600 bg-purple-50 border-purple-200 dark:text-purple-400 dark:bg-purple-900/20 dark:border-purple-800'
  ...
  const getAchievementIcon = (achievement: Achievement) => {
    ...
    if (isEarned) {
      switch (type) {
        ...
        case 'pr': return <TrendingUp className="w-8 h-8 text-green-500" />
        case 'goal': return <Target className="w-8 h-8 text-blue-500" />
  ...
  const getAchievementGradient = (achievement: Achievement) => {
    ...
    if (isEarned) {
      switch (type) {
        case 'streak': return 'from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20'
        case 'pr': return 'from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20'
        case 'goal': return 'from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20'
        case 'milestone': return 'from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20'
        default: return 'from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20'
      }
    } else if (progressPercentage >= 80) {
  ...
  const getRarityColor = (rarity: string) => {
    switch (rarity) {
      case 'legendary': return 'text-yellow-600 bg-yellow-50 border-yellow-200 dark:text-yellow-400 dark:bg-yellow-900/20 dark:border-yellow-800'
      case 'epic': return 'text-purple-600 bg-purple-50 border-purple-200 dark:text-purple-400 dark:bg-purple-900/20 dark:border-purple-800'
      case 'rare': return 'text-blue-600 bg-blue-50 border-blue-200 dark:text-blue-400 dark:bg-blue-900/20 dark:border-blue-800'
      case 'uncommon': return 'text-green-600 bg-green-50 border-green-200 dark:text-green-400 dark:bg-green-900/20 dark:border-green-800'
      default: return 'text-slate-600 bg-slate-50 border-slate-200 dark:text-slate-400 dark:bg-slate-900/20 dark:border-slate-800'
    }
  }
    ...
    switch (sortBy) {
      ...
      case 'progress':
        return filtered.sort((a, b) => {
          if (a.is_earned && !b.is_earned) return -1
          if (!a.is_earned && b.is_earned) return 1
          const aProgress = a.max_progress ? (a.progress || 0) / a.max_progress : 0
          const bProgress = b.max_progress ? (b.progress || 0) / b.max_progress : 0
  ...
  const getAchievementStats = () => {
    ...
    const streaks = achievements.filter(a => a.type === 'streak' && a.is_earned).length
    const prs = achievements.filter(a => a.type === 'pr' && a.is_earned).length
    const goals = achievements.filter(a => a.type === 'goal' && a.is_earned).length
    const milestones = achievements.filter(a => a.type === 'milestone' && a.is_earned).length
          ...
          <div className="max-w-4xl mx-auto space-y-6">
                ...
                <CardContent className="p-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-800 dark:text-slate-200">{stats.earned}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-slate-800 dark:text-slate-200">{stats.locked}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border-0">
                <CardContent className="p-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">Streaks</p>
                      <p className="text-2xl font-bold text-slate-800 dark:text-slate-200">{stats.streaks}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white dark:bg-slate-800 rounded-2xl p-6 shadow-lg border-0">
                <CardContent className="p-0">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-sm text-slate-500 dark:text-slate-400">PRs</p>
                      <p className="text-2xl font-bold text-slate-800 dark:text-slate-200">{stats.prs}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <select 
                        value={sortBy} 
                        onChange={(e) => setSortBy(e.target.value as 'newest' | 'oldest' | 'progress' | 'rarity')}
                        className="w-full px-3 py-2 border border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300"
                      >
            ...
            <div className="space-y-4">
              {filteredAndSortedAchievements().map((achievement) => {
                ...
                return (
                  <Card key={achievement.id} className={`bg-gradient-to-r ${getAchievementGradient(achievement)} rounded-2xl p-6 shadow-lg border-0 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] ${achievement.is_earned ? 'ring-2 ring-yellow-200 dark:ring-yellow-900/30 animate-in fade-in' : 'opacity-75'}`}>
                    <CardContent className="p-0">
                      <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                        ...
                        <div className="flex items-start gap-4 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-2">
                              ...
                              <Badge className={`${rarityColor} rounded-full px-3 py-1`}>
                                {rarity}
                              </Badge>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="text-center">
                              <p className="text-2xl font-bold text-slate-800 dark:text-slate-200">
                                {achievement.is_earned ? '100%' : `${Math.round(progressPercentage)}%`}
                              </p>
                              <p className="text-sm text-slate-500 dark:text-slate-400">
                                {achievement.is_earned ? 'complete' : 'progress'}
                              </p>
                            </div>
                          </div>

                          {/* Progress Bar for Locked Achievements */}
                          {!achievement.is_earned && achievement.max_progress && (
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {achievement.is_earned && (
                              <Button size="sm" className="rounded-xl bg-gradient-to-r from-yellow-500 to-orange-600 text-white">
                ...
                <Card className="bg-white dark:bg-slate-800 rounded-2xl p-12 shadow-lg border-0">
                  <CardContent className="text-center">
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-4">
                      {filterStatus === 'earned' ? 'No Achievements Earned Yet' : 
                       filterStatus === 'locked' ? 'No Locked Achievements' : 
