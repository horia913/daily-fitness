...
export default function NutritionPage() {
  ...
  const renderDailySummary = () => (
    <GlassCard elevation={2} className="p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <SummaryItem
          label="Calories"
          value={`${formatNumber(dailyTotals.calories, 0)} kcal`}
        />
        <SummaryItem
          label="Protein"
          value={`${formatNumber(dailyTotals.protein, 0)} g`}
        />
        <SummaryItem
          label="Carbs"
          value={`${formatNumber(dailyTotals.carbs, 0)} g`}
        />
        <SummaryItem
          label="Fat"
          value={`${formatNumber(dailyTotals.fat, 0)} g`}
        />
      </div>
    </GlassCard>
  );
        ...
        <GlassCard elevation={2} className="p-6 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <p
              ...
              style={{ color: isDark ? "#fff" : "#0f172a" }}
            >
              No active meal plan assigned. Contact your coach.
            </p>
          </div>
        </GlassCard>
      );
            ...
            >
                  ...
                  <div className="space-y-2">
                    {meal.foodItems.map((item) => (
                      ...
                      >
                        ...
                        <div
                          className="text-right ml-3 text-xs"
              ...
              >
                <div className="flex items-center justify-between text-sm font-semibold">
                  <span style={{ color: isDark ? "#fff" : "#0f172a" }}>
                    Meal Totals
                  </span>
                  <span style={{ color: isDark ? "#fff" : "#0f172a" }}>
              ...
              <Button
                ...
                style={{
                  ...
                  opacity: uploadingMealId === meal.id ? 0.7 : 1,
                }}
              >
  ...
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 p-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p
                ...
                style={{ color: isDark ? "#cbd5e1" : "#64748b" }}
              >
                View your assigned meals and log photos for today.
              </p>
            </div>
            {errorMessage && (
              <div className="text-sm text-red-500 bg-red-50 border border-red-200 rounded-lg px-3 py-2 max-w-md">
                {errorMessage}
              </div>
            )}
          </div>
...
function SummaryItem({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl px-4 py-3 bg-white/70 dark:bg-slate-800/60 shadow-sm border border-slate-100 dark:border-slate-700">
      <p className="text-sm text-slate-500 dark:text-slate-300 mb-1">{label}</p>
